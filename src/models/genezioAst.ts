...
export interface PromiseType extends Node {
  ...
  rawType: DoubleType | IntegerType | StringType | BooleanType | FloatType | ArrayType | AnyType | PromiseType | CustomNodeType;
}
...
export interface Enum extends Node {
  ...
  name: string;
  cases: StringType[] | IntegerType[] | BooleanType[] | FloatType[] | DoubleType[];
}
...
export interface TypeAlias extends Node {
  ...
  name: string;
  aliasType: DoubleType | IntegerType | StringType | BooleanType | FloatType | AnyType ;
}
...
export interface MethodDefinition extends Node {
  ...
  kind: MethodKindEnum;
  static: boolean;
  returnType: DoubleType | IntegerType | StringType | BooleanType | FloatType | AnyType | PromiseType | CustomNodeType;
}
