export class GenezioCloudFormationBuilder {
    ...
    addDefaultResourcesForBackendDeployment(apiGatewayResourceName: string, apiGatewayName: string) {
...
export function getLambdaPermissionResource(lambdaFunctionResourceName: string, apiGatewayResourceName: string) {
    return {
...
export function getApiGatewayRouteResource(apiGatewayResourceName: string, routeKey: string, integration: string) {
    return {
...
export function getApiGatewayIntegrationResource(apiGatewayResourceName: string, lambdaFunctionResourceName: string) {
    return {
...
export function getEventsRoleResource(scheduleExpression: string, lambdaFunctionResourceName: string, targetId: string, input: string) {
    return {
...
export function getLambdaPermissionForEventsResource(lambdaFunctionResourceName: string, cronResourceName: string) {
    return {
        "Type": "AWS::Lambda::Permission",
        "Properties": {
            "Action": "lambda:InvokeFunction",
...
export function getS3BucketResource(websiteConfiguration: any | undefined = undefined, accessControl: string | undefined = undefined, publicAccessBlockConfig: any | undefined = undefined) {
