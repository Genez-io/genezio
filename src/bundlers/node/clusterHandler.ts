export const clusterWrapperCode = 1;

export function generateNodeClusterHandler(socketsEnabled: boolean) {
    return (
        `
  import { handler as userHandler } from "./index.mjs";
  import http from "http";
  ` +
        (socketsEnabled ? `import { Server } from 'socket.io';` : "") +
