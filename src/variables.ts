...
export { REACT_APP_BASE_URL, FRONTEND_DOMAIN, BACKEND_ENDPOINT, GENERATE_SDK_API_URL, PORT_LOCAL_ENVIRONMENT, ENABLE_DEBUG_LOGS_BY_DEFAULT, LOCAL_TEST_INTERFACE_URL };
